...
from .dpt_head import DPTPts3dPose, DPTPts3dPoseDyMask
...
def head_factory(
    ...
    elif head_type == "dpt" and output_mode == "pts3d+pose+dymask":
        return DPTPts3dPoseDyMask(net, has_conf, has_rgb, has_pose)
    else:
        raise NotImplementedError(f"unexpected {head_type=} and {output_mode=}")
